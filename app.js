...
function adjustMarket(room) {
  ...
  for (let i = 0; i < playerPhases.length; i++) {
    ...
    if (playerInfluence === "+1") {
      rooms[room].market[playerColor] =
        rooms[room].market[playerColor] === 90
          ? 10
          : rooms[room].market[playerColor] + 10;
